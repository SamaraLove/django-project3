...
class StoryForm(ModelForm):
    ...
    class Meta:
        model = NewsStory
        fields = ['title', 'author', 'pub_date', 'content','image_link']
        widgets = {
            ...
            'image_link': forms.TextInput(attrs={'size': 10, 'class': "form-item",'placeholder': 'Enter URL to a direct image. If the link does not directly show an image, a random one will be chosen for you',})
